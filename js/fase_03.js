...
Calciumtrice.Fase_03.prototype = {
    create: function () {
        ...
        this.layersTelhados['telhadoCasa05'] = this.mapaGlobal.createLayer('telhadoCasa05');
        this.layersTelhados['telhadoCasa06'] = this.mapaGlobal.createLayer('telhadoCasa06');
        this.layersTelhados['telhadoCasa07'] = this.mapaGlobal.createLayer('telhadoCasa07');
        this.layersTelhados['telhadoCasa08'] = this.mapaGlobal.createLayer('telhadoCasa08');
        this.layersTelhados['telhadoCasa09'] = this.mapaGlobal.createLayer('telhadoCasa09');
        this.layersTelhados['telhadoCasa10'] = this.mapaGlobal.createLayer('telhadoCasa10');
        this.layersTelhados['telhadoCasa11'] = this.mapaGlobal.createLayer('telhadoCasa11');
        this.layersTelhados['telhadoCasa12'] = this.mapaGlobal.createLayer('telhadoCasa12');
        this.layersTelhados['telhadoCasa13'] = this.mapaGlobal.createLayer('telhadoCasa13');
        this.layersTelhados['telhadoCasa14'] = this.mapaGlobal.createLayer('telhadoCasa14');
        this.layersTelhados['telhadoCasa15'] = this.mapaGlobal.createLayer('telhadoCasa15');
        this.layersTelhados['telhadoCasa16'] = this.mapaGlobal.createLayer('telhadoCasa16');
        this.layersTelhados['telhadoCasa17'] = this.mapaGlobal.createLayer('telhadoCasa17');
        this.layersTelhados['telhadoCasa18'] = this.mapaGlobal.createLayer('telhadoCasa18');
        this.layersTelhados['telhadoCasa19'] = this.mapaGlobal.createLayer('telhadoCasa19');
        this.layersTelhados['telhadoCasa20'] = this.mapaGlobal.createLayer('telhadoCasa20');
    ...
    passaFase:function(){
        Calciumtrice.game.state.start('fase_04'); 
    },
    update: function () {   
